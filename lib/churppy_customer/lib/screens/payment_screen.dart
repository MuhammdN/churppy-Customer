...
class _PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    ...
    _loadUserId();
    debugPrint(
        "🟢 PaymentScreen opened with itemId: ${widget.itemId}, qty: ${widget.quantity}, total: ${widget.totalPrice}");
    _loadUserProfile();
  }
  ...
  Future<void> _loadUserId() async {
    final prefs = await SharedPreferences.getInstance();
    final userString = prefs.getString("user"); // 👈 same key jaisa baaki screens me
    if (userString != null) {
      final userMap = jsonDecode(userString);
      setState(() {
    ...
    debugPrint("👤 Loaded _userId in PaymentScreen: $_userId");
  }
          ...
          child: (_profileImageUrl == null || !_profileImageUrl!.startsWith("http"))
            ...
            color: Colors.grey[800],
              ...
              : null,
                  ...
                  _summaryRow("Order (${widget.quantity} items)",
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Icon(Icons.arrow_forward_ios,
                          size: fs(14), color: Colors.purple),
                    ],
                  ),
  ...
  Widget _paymentCard({
    ...
    return GestureDetector(
      ...
      child: Container(
        padding:
        EdgeInsets.symmetric(horizontal: fs(12), vertical: fs(10)),
