...
class _ContactSupportScreenState extends State<ContactSupportScreen> {
  ...
  final String apiUrl =
      "https://churppy.eurekawebsolutions.com/api/contact_support.php"; // ✅ single file
  ...
  /// Load user_id + profile image + fetch messages
  Future<void> _loadUserIdAndFetch() async {
    ...
    if (userString != null) {
      ...
      _profileImageUrl = userMap['image']; // 👤 profile image URL load ki
    }
                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return _ChatRow(
                              ...
                              fs: fs,
                              purple: purple,
                              profileImageUrl: _profileImageUrl, // 👈 pass kiya
                            );
                          },
                        ),
                      ),
                      ...
                      // Input bar
                      Padding(
                        padding: EdgeInsets.fromLTRB(0, 0, 0, fs(12)),
                        child: Row(
                          children: [
                            Expanded(
                              child: Container(
...
class _ChatRow extends StatelessWidget {
  ...
  final Color purple;
  final String? profileImageUrl; // 👤 user image URL
