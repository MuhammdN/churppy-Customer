...
class _MenuScreenState extends State<MenuScreen> {
  ...
  int? userId;
  Set<int> favoriteItems = {}; // To track favorite items
  ...
  Future<void> _loadUserId() async {
    ...
    if (userString != null) {
      ...
      print("✅ User ID on MenuScreen: $userId");
    } else {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              /// Restaurant Info (Static for now)
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ClipRRect(
  ...
  Widget _productCard(
    ...
    String? fullImageUrl;
    if (item.image.isNotEmpty && item.image.length > 5) {
            ...
            child: InkWell(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (_) => ProductDetailsScreen(itemId: item.id),
                ));
              },
