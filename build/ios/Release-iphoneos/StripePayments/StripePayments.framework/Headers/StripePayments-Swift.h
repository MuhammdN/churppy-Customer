...
typedef SWIFT_ENUM(NSInteger, STPBankAccountHolderType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPBankAccountStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPCardBrand, closed) {
/// Visa card
  STPCardBrandVisa = 0,
...
typedef SWIFT_ENUM(NSInteger, STPCardFundingType, closed) {
/// Debit card funding
...
typedef SWIFT_ENUM(NSInteger, STPCollectBankAccountError, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPConnectAccountBusinessType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPFPXBankBrand, closed) {
/// Maybank2U
...
/// seealso:
/// https://stripe.com/docs/file-upload
typedef SWIFT_ENUM(NSInteger, STPFilePurpose, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPIntentActionType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPKlarnaLineItemType, closed) {
...
/// seealso:
/// https://stripe.com/docs/sources/klarna#create-source
typedef SWIFT_ENUM(NSInteger, STPKlarnaPaymentMethods, closed) {
...
/// The type of customer acceptance information included with the Mandate.
typedef SWIFT_ENUM(NSInteger, STPMandateCustomerAcceptanceType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPMicrodepositType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPaymentHandlerActionStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPaymentHandlerErrorCode, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPaymentIntentActionType, closed) {
/// This is an unknown action, that’s been added since the SDK
/// was last updated.
/// Update your SDK, or use the <code>nextAction.allResponseFields</code>
/// for custom handling.
...
typedef SWIFT_ENUM(NSInteger, STPPaymentIntentCaptureMethod, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPaymentIntentConfirmationMethod, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPaymentIntentLastPaymentErrorType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPaymentIntentSetupFutureUsage, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPaymentIntentSourceActionType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPaymentIntentStatus, closed) {
/// Unknown status
...
typedef SWIFT_ENUM(NSInteger, STPPaymentMethodCardCheckResult, closed) {
/// The check passed.
...
typedef SWIFT_ENUM(NSInteger, STPPaymentMethodCardWalletType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPaymentMethodType, closed) {
...
/// Account holder type
typedef SWIFT_ENUM(NSInteger, STPPaymentMethodUSBankAccountHolderType, closed) {
/// This is an unknown type that’s been added since the SDK
/// was last updated.
/// Update your SDK, or use the <code>allResponseFields</code>
/// for custom handling.
...
/// Account type
typedef SWIFT_ENUM(NSInteger, STPPaymentMethodUSBankAccountType, closed) {
/// This is an unknown type that’s been added since the SDK
/// was last updated.
/// Update your SDK, or use the <code>allResponseFields</code>
/// for custom handling.
...
typedef SWIFT_ENUM(NSInteger, STPPaymentStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPPinStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPRedirectContextError, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPRedirectContextState, closed) {
...
typedef SWIFT_ENUM(NSUInteger, STPSetupIntentLastSetupErrorType, closed) {
/// An unknown error type.
...
typedef SWIFT_ENUM(NSInteger, STPSetupIntentStatus, closed) {
/// Unknown status
...
typedef SWIFT_ENUM(NSInteger, STPSetupIntentUsage, closed) {
/// Unknown value.  Update your SDK, or use <code>allResponseFields</code> for custom handling.
...
typedef SWIFT_ENUM(NSInteger, STPSourceCard3DSecureStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPSourceFlow, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPSourceRedirectStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPSourceStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPSourceType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPSourceUsage, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPSourceVerificationStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPThreeDSButtonTitleStyle, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPThreeDSCustomizationButtonType, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPTokenType, closed) {
/// Account token type
