...
typedef SWIFT_ENUM(NSInteger, STPBankSelectionMethod, closed) {
/// FPX (Malaysia)
...
typedef SWIFT_ENUM(NSUInteger, STPBillingAddressFields, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPShippingStatus, closed) {
...
typedef SWIFT_ENUM(NSInteger, STPShippingType, closed) {
