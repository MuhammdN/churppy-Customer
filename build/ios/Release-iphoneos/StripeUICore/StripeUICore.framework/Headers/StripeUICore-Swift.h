...
/// For internal SDK use only
SWIFT_CLASS_NAMED("CheckboxButton")
...
@interface STP_Internal_CheckboxButton (SWIFT_EXTENSION(StripeUICore)) <UITextViewDelegate>
...
/// A textfield whose input view is a <code>UIPickerView</code> (on iOS) or a <code>UIMenu</code> (on Catalyst) with a list of the strings.
/// For internal SDK use only
...
/// A <code>UIImageView</code> that dynamically changes it’s <code>image</code> according to the brightness of the
/// <code>pairedColor</code>.
SWIFT_CLASS_NAMED("DynamicImageView")
...
@interface STP_Internal_OneTimeCodeTextField (SWIFT_EXTENSION(StripeUICore))
...
@interface STP_Internal_OneTimeCodeTextField (SWIFT_EXTENSION(StripeUICore)) <UIKeyInput>
...
@interface STP_Internal_OneTimeCodeTextField (SWIFT_EXTENSION(StripeUICore)) <UITextInput>
...
SWIFT_CLASS("_TtC12StripeUICore21STPVPANumberValidator")
...
/// Commonly referred to as <code>borderWidth</code>
